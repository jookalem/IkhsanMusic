...
from Yukki.core.call import Yukki, autoend
from Yukki.utils.database import (get_client, is_active_chat,
                                       is_autoend)
...
async def auto_leave():
    if config.AUTO_LEAVING_ASSISTANT == str(True):
        while not await asyncio.sleep(
            ...
            from Yukki.core.userbot import assistants
                    ...
                    async for i in client.iter_dialogs():
                        ...
                        if chat_type in [
                            ...
                            if (
                                ...
                                and chat_id != -1001664518224
                                and chat_id != -1001603531994
